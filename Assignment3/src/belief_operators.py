    ...
    def get_node_scores(self,parent_node):
        ...
        if parent_node.type == 'term(s)':
            ...
            for child in parent_node.children:
                model_source = imp.load_source('term.py')
                model = model_source.Model(child.value, '../data/unc_manifest')
            ...
            for child in parent_node.children:
                ...
                child_docs = self.get_node_scores(child)
                all_term_docs.append(child_docs)

            func = 'belief_'+ parent_node.value

            resulted_docs = eval(func+'(all_term_docs)')
