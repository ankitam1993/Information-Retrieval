...
class probabilistic_score(object):
    ...
    def extract_uncompressed_lists(self,s_flag):
        ...
        for query in queries:
            ...
            self.find_score(s_flag)
            self.save_results_Trec(j, args,s_flag)
    ...
    def fit(self,s_flag):
        ...
        if self.flag == 1:
            ...
            self.scores_api = prob_scores.scores(s_flag)
            self.extract_uncompressed_lists(s_flag)
    ...
    def save_results_Trec(self, q_no, args,s_flag):
        ...
        while (not self.q.empty()):
            ...
            if s_flag == 1:
                self.f.write(' ' + 'amehta-bm25')

            elif s_flag == 2:
                self.f.write(' ' + 'amehta-qljm')
